...
export const AboutPage = () => {
  ...
  return (
    <div>
      <div className="full-height-screen">
        <div className="full-width-container w1-2">
          <div className={style["title"]}>
            <h1>This is Us.</h1>
            <h2 onClick={() => scrollToSection(ourstory)}>#ourstory</h2>
            <h2 onClick={() => scrollToSection(ourstory)}>#foundersjourney</h2>
            <h2 onClick={() => scrollToSection(ourmission)}>#ourmission</h2>
            <h2 onClick={() => scrollToSection(theteam)}>#theteam</h2>
          </div>
          <img title="Eofis Logo" src={logo} alt="Eofis logo" />
        </div>
      </div>
      <div ref={ourstory} className="full-height-screen">
        <div className="full-width-container w1-2">
      ...
      <div ref={ourmission} className="full-height-screen-column">
        <div className={style["section"]}>
          <h1>Our Mission</h1>
